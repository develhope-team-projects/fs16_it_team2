...
const PremiumPlus = ({ type, price, title }) => {
      ...
      <div className="flex flex-wrap gap-7 mt-8 p-4 bg-transparent text-center ">
        <div className="w-full m-auto  border-2 rounded-3xl  custom-box-shadow flex flex-col items-center justify-center">
          <div className=" flex flex-col items-center justify-center gap-2 lg:gap-5 mb-2 lg:mb-8 ">
            <div className="w-full  rounded-t-3xl flex items-center justify-center bg-gradient-to-t from-white to-pink-300 dark:from-black dark:to-pink-600 opacity-80">
          ...
          >
            <li
              className={`-mb-px mr-2 lg:w-52 w-36   last:mr-0 flex-auto  text-center text-gray-500 border-2 rounded-3xl ${
                openTab === 1 ? "border-2 border-pink-500" : ""
              }`}
            >
              <a
                className={
              ...
              >
                ...
                <div className="flex flex-col">
                  <h3 className="text-pink-500">Popular</h3>
            ...
            <li
              className={`-mb-px mr-2 lg:w-52 w-36  last:mr-0 flex-auto text-center text-gray-500 border-2 rounded-3xl ${
                openTab === 2 ? "border-2 border-pink-500" : ""
              }`}
            >
              <a
                className={
            ...
            <li
              className={`-mb-px mr-2 lg:w-52 w-36   last:mr-0 flex-auto text-center text-gray-500 border-2 rounded-3xl ${
                openTab === 3 ? "border-2 border-pink-500" : ""
              }`}
            >
              <a
                className={
              ...
              >
                <div>
                  <h3 className="text-pink-500">Best value</h3>
            ...
            <div className="px-4 py-5 flex-auto">
              <div className="tab-content tab-space">
                ...
                >
                  ...
                  <Link to="/app/payment">
                  <div className="btn text-base rounded-full px-4 py-2 lg:px-9 lg:py-3 bg-gradient-to-r from-pink-200 to-pink-600 ">
                      Continue
                    </div>
                  </Link>
                </div>
                ...
                >
                  <div className="flex">
                  <div className="text-pink-500 text-xl lg:text-3xl">
                      <IoIceCreamSharp className="lg:text-3xl text-xl" />
                    </div>
                    <div>
