...
const PremiumPlatinum = ({ type, price, title }) => {
      ...
      <div className="flex flex-wrap gap-7 mt-8 p-4 bg-transparent text-center ">
        <div className="w-full m-auto  border-2 rounded-3xl  custom-box-shadow flex flex-col items-center justify-center">
          <div className=" flex flex-col items-center justify-center gap-2 lg:gap-5 mb-2 lg:mb-8 ">
            <div className="w-full  rounded-t-3xl flex items-center justify-center bg-gradient-to-t from-white to-zinc-300 dark:from-black dark:to-zinc-600 opacity-80">
            ...
            <div className="flex flex-col items-center lg:gap-5 dark:text-gray-200">
              <h2 className="hidden lg:block lg:text-4xl text-base text-center px-3">
                See who likes you with Friendzone platinum
              </h2>
          ...
          >
            <li
              className={`-mb-px mr-2 lg:w-52 w-36   last:mr-0 flex-auto  text-center text-gray-500 border-2 rounded-3xl ${
                openTab === 1 ? "border-2 border-zinc-500" : ""
              }`}
            >
              <a
                className={
              ...
              >
                ...
                <div className="flex flex-col">
                  <h3 className="text-zinc-500">Popular</h3>
            ...
            <li
              className={`-mb-px mr-2 lg:w-52 w-36  last:mr-0 flex-auto text-center text-gray-500 border-2 rounded-3xl ${
                openTab === 2 ? "border-2 border-zinc-500" : ""
              }`}
            >
              <a
                className={
            ...
            <li
              className={`-mb-px mr-2 lg:w-52 w-36   last:mr-0 flex-auto text-center text-gray-500 border-2 rounded-3xl ${
                openTab === 3 ? "border-2 border-zinc-500" : ""
              }`}
            >
              <a
                className={
              ...
              >
                <div>
                  <h3 className="text-zinc-500">Best value</h3>
              ...
              <div className="tab-content tab-space">
                ...
                >
                  <div className="flex">
                    ...
                    <div>
                      <div className="dark:text-gray-200 text-xl lg:text-3xl">
                        1week
                      </div>
                      <p className="dark:text-gray-100 text-base lg:text-xl">
                        19€/week
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="flex">
                    <div className="text-zinc-500 text-xl lg:text-3xl">
                      <IoIceCreamSharp className="lg:text-3xl text-xl" />
                    </div>
                    <div>
                      <div className="dark:text-gray-200 text-xl lg:text-3xl">
