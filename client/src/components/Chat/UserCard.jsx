...
const UserCard = ({ chat, user }) => {
  ...
  return (
    <>
      {/* SINGLE USER CARD */}
      <div className="relative flex items-center md:justify-between justify-center p-2 space-x-3 text-black active:bg-black dark:hover:bg-violet-900 hover:bg-violet-400 cursor-pointer min-w-[5rem] md:min-w-[14rem] lg:min-w-[26rem] dark:active:bg-violet-500 md:rounded-2xl  border-b-[1px] md:border-2 transition border-violet-800 mb-1">
        ...
        <div className="flex">
          ...
          <div className="UserDataInfo">
            {/* NAME, SURNAME */}
            <div className="hidden text-lg font-bold tracking-wide dark:text-sky-500 md:flex">
        ...
        <div className="flex flex-col items-end">
          <div className="hidden text-sm text-gray-500 lg:flex dark:text-gray-400">{moment(latestMessage?.createdAt).calendar()}</div>
