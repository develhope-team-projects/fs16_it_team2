...
const CentralSection = ({ cardContent }) => {
  return (
    <div className="relative">
      <img
        className="z-30 p-4 w-40 custom-bounce absolute right-10 bottom-10"
        src={icecream1}
        alt="icecream 1"
      />
      <img
        className=" p-4 w-40 z-30 custom-bounce absolute right-10 top-1/4"
        src={icecream3}
        alt="icecream 1"
      />
      <img
        className="p-4 w-40 z-30 custom-bounce absolute top-10 left-10"
        src={icecream2}
        alt="icecream 2"
      />
      <img
        className="p-4 w-40 z-30 custom-bounce absolute bottom-1/4 left-10"
        src={icecream4}
        alt="icecream 4"
      />
      ...
      <div className="flex flex-col z-1 items-center justify-center w-[100%]"> 
