      ...
      <div className="flex flex-wrap gap-7 mt-8 p-4 bg-transparent">
        <div className="w-full m-auto  border-2 rounded-3xl  custom-box-shadow">
          <div className=" flex flex-col gap-5 mb-8 ">
            <div className="rounded-t-3xl flex items-center justify-center bg-gradient-to-t from-zinc-200 to-zinc-500 dark:from-black dark:to-zinc-600 opacity-80">
                ...
                >
                  <div className="flex">
                    <div className="text-zinc-500">
                      <IoIceCreamSharp size={50} className="text-zinc-500" />
                    </div>
                    <div>
                  ...
                  <Link to="/payment">
                    <div className="btn text-base rounded-full px-9 py-3 bg-gradient-to-r from-zinc-200 to-zinc-600 ">
                      Continue
                    </div>
                  </Link>
                </div>
